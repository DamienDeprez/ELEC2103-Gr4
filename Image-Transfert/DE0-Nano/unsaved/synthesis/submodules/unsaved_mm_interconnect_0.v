...
module unsaved_mm_interconnect_0 (
		...
		output wire [7:0]  MTL_ip_0_s0_address,                            //                              MTL_ip_0_s0.address
		output wire        MTL_ip_0_s0_write,                              //                                         .write
		output wire        MTL_ip_0_s0_read,                               //                                         .read
		input  wire [31:0] MTL_ip_0_s0_readdata,                           //                                         .readdata
		output wire [31:0] MTL_ip_0_s0_writedata,                          //                                         .writedata
		input  wire        MTL_ip_0_s0_waitrequest,                        //                                         .waitrequest
	...
	wire  [17:0] mtl_ip_0_s0_agent_m0_address;                                                       // MTL_ip_0_s0_agent:m0_address -> MTL_ip_0_s0_translator:uav_address
	...
	wire  [94:0] mtl_ip_0_s0_agent_rf_source_data;                                                   // MTL_ip_0_s0_agent:rf_source_data -> MTL_ip_0_s0_agent_rsp_fifo:in_data
	...
	wire  [94:0] mtl_ip_0_s0_agent_rsp_fifo_out_data;                                                // MTL_ip_0_s0_agent_rsp_fifo:out_data -> MTL_ip_0_s0_agent:rf_sink_data
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> MTL_ip_0_s0_agent:cp_valid
	wire  [93:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> MTL_ip_0_s0_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // MTL_ip_0_s0_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> MTL_ip_0_s0_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> MTL_ip_0_s0_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> MTL_ip_0_s0_agent:cp_endofpacket
	...
	wire         mtl_ip_0_s0_agent_rp_valid;                                                         // MTL_ip_0_s0_agent:rp_valid -> router_005:sink_valid
	wire  [93:0] mtl_ip_0_s0_agent_rp_data;                                                          // MTL_ip_0_s0_agent:rp_data -> router_005:sink_data
	wire         mtl_ip_0_s0_agent_rp_ready;                                                         // router_005:sink_ready -> MTL_ip_0_s0_agent:rp_ready
	wire         mtl_ip_0_s0_agent_rp_startofpacket;                                                 // MTL_ip_0_s0_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         mtl_ip_0_s0_agent_rp_endofpacket;                                                   // MTL_ip_0_s0_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         mtl_ip_0_s0_agent_rdata_fifo_src_valid;                                             // MTL_ip_0_s0_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] mtl_ip_0_s0_agent_rdata_fifo_src_data;                                              // MTL_ip_0_s0_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         mtl_ip_0_s0_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_003:in_0_ready -> MTL_ip_0_s0_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> MTL_ip_0_s0_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> MTL_ip_0_s0_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // MTL_ip_0_s0_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> MTL_ip_0_s0_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.av_write               (MTL_ip_0_s0_write),                              //                         .write
		.av_read                (MTL_ip_0_s0_read),                               //                         .read
		.av_readdata            (MTL_ip_0_s0_readdata),                           //                         .readdata
		.av_writedata           (MTL_ip_0_s0_writedata),                          //                         .writedata
		.av_waitrequest         (MTL_ip_0_s0_waitrequest),                        //                         .waitrequest
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
		.av_byteenable          (),                                               //              (terminated)
	...
	unsaved_mm_interconnect_0_cmd_demux_001 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
