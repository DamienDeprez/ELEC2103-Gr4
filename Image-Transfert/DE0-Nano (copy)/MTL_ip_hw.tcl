...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL MTL_custom_ip
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE true
add_fileset_file MTL_custom_ip.sv SYSTEM_VERILOG PATH MTL_custom_ip.sv TOP_LEVEL_FILE
...
add_interface_port reset_sink GPIO_0 reset_n Input 1


# 
# connection point MTL_conduit
# 
add_interface MTL_conduit conduit end
set_interface_property MTL_conduit associatedClock ""
set_interface_property MTL_conduit associatedReset ""
set_interface_property MTL_conduit ENABLED true
set_interface_property MTL_conduit EXPORT_OF ""
set_interface_property MTL_conduit PORT_NAME_MAP ""
set_interface_property MTL_conduit CMSIS_SVD_VARIABLES ""
set_interface_property MTL_conduit SVD_ADDRESS_GROUP ""

add_interface_port MTL_conduit MTL_DCLK export Bidir 1
...
add_interface_port conduit_end MTL_HSD export Output 1
...
add_interface_port conduit_end_1 MTL_VSD export Output 1
...
add_interface_port conduit_end_2 MTL_TOUCH_I2C_SCL export Output 1
...
add_interface_port conduit_end_3 MTL_TOUCH_I2C_SDA export Bidir 1
...
add_interface_port conduit_end_4 MTL_TOUCH_INT_n export Input 1
...
add_interface_port conduit_end_5 MTL_R export Output 8
...
add_interface_port conduit_end_6 MTL_G export Output 8
...
add_interface_port conduit_end_7 MTL_B export Output 8
...
add_interface_port conduit_end_8 DRAM_ADDR export Output 13
...
add_interface_port conduit_end_9 DRAM_BA export Output 2
...
add_interface_port conduit_end_10 DRAM_CAS_N export Output 1
...
add_interface_port conduit_end_11 DRAM_CKE export Output 1
...
add_interface_port conduit_end_12 DRAM_CLK export Output 1
...
add_interface_port conduit_end_13 DRAM_CS_N export Output 1
...
add_interface_port conduit_end_14 DRAM_DQ export Bidir 16
...
add_interface_port conduit_end_15 DRAM_DQM export Output 2
...
set_interface_property conduit_end_16 associatedClock clock_sink
...
add_interface_port conduit_end_16 DRAM_RAS_N export Output 1
...
set_interface_property conduit_end_17 associatedClock clock_sink
...
add_interface_port conduit_end_17 DRAM_WE_N export Output 1
...
set_interface_property conduit_end_18 associatedClock clock_sink
...
add_interface_port conduit_end_18 iSPI_CLK export Input 1
...
add_interface_port conduit_end_19 iSPI_CS export Input 1
...
set_interface_property conduit_end_20 associatedClock clock_sink
...
add_interface_port conduit_end_20 iSPI_MOSI export Input 1


# 
# connection point conduit_end_21
# 
add_interface conduit_end_21 conduit end
set_interface_property conduit_end_21 associatedClock clock_sink
set_interface_property conduit_end_21 associatedReset ""
set_interface_property conduit_end_21 ENABLED true
set_interface_property conduit_end_21 EXPORT_OF ""
set_interface_property conduit_end_21 PORT_NAME_MAP ""
set_interface_property conduit_end_21 CMSIS_SVD_VARIABLES ""
set_interface_property conduit_end_21 SVD_ADDRESS_GROUP ""

add_interface_port conduit_end_21 oSPI_MISO export Output 1
