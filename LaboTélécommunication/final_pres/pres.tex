...
\begin{itemize}
\item[$\bullet$] In OFDM, differents attenuations on each symbols due to mulipath(Frequency-selective channel)
\end{itemize}
\end{frame}
...
\item[$\bullet$] Need less power (need less bandwidth) 
